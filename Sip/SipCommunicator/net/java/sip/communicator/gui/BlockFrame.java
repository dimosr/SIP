...
public class BlockFrame extends JDialog {
	...
	public static void main(String[] args) {
		try {
			BlockFrame dialog = new BlockFrame();
	...
	public BlockFrame() {
		setModal(true);
		canceled = true;
		setTitle("Block Calls from Users");
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				toBlock = new JRadioButton("Block");
				buttonGroup.add(toBlock);
				toBlock.setMnemonic('B');
				panel.add(toBlock);
			}
			{
				toUnblock = new JRadioButton("Unblock");
